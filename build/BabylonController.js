...
var BabylonController = /** @class */ (function () {
    ...
    BabylonController.prototype.setUp = function () {
        ...
        var camera = new BABYLON.ArcRotateCamera("camera", Math.PI / 6, Math.PI / 2.5, 6, new BABYLON.Vector3(0, 0, 0));
        ...
        BABYLON.SceneLoader.Append("/assets/3D/", "morse.glb", this.scene, function (scene) {
