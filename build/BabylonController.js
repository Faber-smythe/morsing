...
var assetPath = document.location.href == "https://faber-smythe.github.io/morsing/"
...
var BabylonController = /** @class */ (function () {
    ...
    BabylonController.prototype.setUpCamera = function () {
        ...
        this.camera = new BABYLON.ArcRotateCamera("camera", 0, 0, this.cameraInitialRadius, new BABYLON.Vector3(0, 0.1, 0));
        ...
        if ("ontouchstart" in document.documentElement) {
            ...
            this.canvas.addEventListener("mousemove", function (e) {
                ...
                GSAP.to(_this.camera, {
                    alpha: _this.cameraInitialAlpha - (Math.PI / 16) * widthTravelRatio,
                    beta: _this.cameraInitialBeta - (Math.PI / 15) * heighTravelRatio,
                    duration: 2,
                });
            });
            ...
            this.canvas.addEventListener("wheel", function (e) {
                ...
                zoomResetTimeout_1 = setTimeout(function () {
                    GSAP.to(_this.camera, {
                        radius: _this.cameraInitialRadius,
                        duration: 1,
                    });
                }, 1000);
            });
    ...
    BabylonController.prototype.setUpLightsAndEffect = function () {
        var _this = this;
        // Lights
        this.roomLight = new BABYLON.PointLight("roomLight", new BABYLON.Vector3(1.18, 0.64, -0.56), this.scene);
        ...
        this.scene.meshes
            .filter(function (mesh) { return mesh.name.includes("post."); })
            .forEach(function (postMesh) {
